...
import Register from './registePage';
import registePage from './registePage';

export default function App() {
  class onclick extends Component {
    _onItemPressed(item){
      this._registePage.Register();
  }
  }
  const [value, onChangeText] = React.useState('Useless Placeholder')
  // const regis_pg = ('./registePage.js')
  return (
    <View style={styles.container}>
      <ImageBackground style={styles.imageBg} source={require('./icon/wallpaper/BG.png')}>
        ...
        <Text>
          ...
          <Text>   </Text>
          <TouchableOpacity onPress={() => this._onItemPressed.bind(this)}>
